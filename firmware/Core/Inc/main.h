...
#define PIN_BOOM_PGOOD_IN_TBC_Pin GPIO_PIN_4
#define PIN_BOOM_PGOOD_IN_TBC_GPIO_Port GPIOA
...
#define PIN_SPI_NCS_FLASH_7_Pin GPIO_PIN_11
#define PIN_SPI_NCS_FLASH_7_GPIO_Port GPIOF
#define PIN_SPI_NCS_FLASH_6_Pin GPIO_PIN_12
#define PIN_SPI_NCS_FLASH_6_GPIO_Port GPIOF
#define PIN_SPI_NCS_FLASH_5_Pin GPIO_PIN_13
#define PIN_SPI_NCS_FLASH_5_GPIO_Port GPIOF
#define PIN_SPI_NCS_FLASH_4_Pin GPIO_PIN_14
#define PIN_SPI_NCS_FLASH_4_GPIO_Port GPIOF
#define PIN_SPI_NCS_FLASH_3_Pin GPIO_PIN_15
#define PIN_SPI_NCS_FLASH_3_GPIO_Port GPIOF
#define PIN_SPI_NCS_FLASH_2_Pin GPIO_PIN_0
#define PIN_SPI_NCS_FLASH_2_GPIO_Port GPIOG
#define PIN_SPI_NCS_FLASH_1_Pin GPIO_PIN_1
#define PIN_SPI_NCS_FLASH_1_GPIO_Port GPIOG
#define PIN_SPI_NCS_FLASH_0_Pin GPIO_PIN_7
#define PIN_SPI_NCS_FLASH_0_GPIO_Port GPIOE
#define PIN_SPI_NCS_FRAM_1_Pin GPIO_PIN_8
#define PIN_SPI_NCS_FRAM_1_GPIO_Port GPIOE
#define PIN_SPI_NCS_FRAM_0_Pin GPIO_PIN_9
#define PIN_SPI_NCS_FRAM_0_GPIO_Port GPIOE
