...
#define PIN_STACK_I2C1_SCL_Pin GPIO_PIN_8
#define PIN_STACK_I2C1_SCL_GPIO_Port GPIOB
#define PIN_STACK_I2C1_SDA_Pin GPIO_PIN_9
#define PIN_STACK_I2C1_SDA_GPIO_Port GPIOB
