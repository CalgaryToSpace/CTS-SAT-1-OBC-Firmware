...
extern const uint16_t UART_mpi_buffer_len;                      // Length of the UART MPI response buffer (for telecommand responses only & NOT SCIENCE DATA)
extern volatile uint8_t UART_mpi_buffer[];                      // Buffer for UART MPI response
...
extern volatile uint8_t UART_gps_buffer_last_rx_byte;           // Last received byte for GPS response
