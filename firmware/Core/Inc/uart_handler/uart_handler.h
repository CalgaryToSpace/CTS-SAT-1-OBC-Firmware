...
extern const uint16_t UART_mpi_rx_buffer_len; // Length of the UART MPI response buffer (Set to 50 bytes which is an estimate considering the telecommand responses only & NOT SCIENCE DATA)
