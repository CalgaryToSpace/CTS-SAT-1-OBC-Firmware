...
uint8_t EPS_struct_pdu_overcurrent_fault_comparison_TO_json(const EPS_struct_pdu_overcurrent_fault_comparison_t *comparison, const EPS_struct_pdu_overcurrent_fault_state_t *status_before, const EPS_struct_pdu_overcurrent_fault_state_t *status_after, char json_output_str[], uint16_t json_output_str_size);
