...
/*-----------------------------DEFINES-----------------------------*/
// Number of total memory blocks available
#define FLASH_NUMBER_OF_FLASH_DEVICES 8 // TODO: Update to 8, or 10 with FRAM maybe

// Size of a singular FLASH Memory Module in bytes
#define FLASH_CHIP_SIZE_BYTES 67108864 // 64 Megabytes // TODO: Update

// Size of an erasable block in bytes. (lfs.h - Line 205)
#define FLASH_CHIP_BLOCK_SIZE_BYTES 262144

// Minimum size that can be programmed/read in bytes (also known as page size)
...
uint8_t FLASH_read_status_register(SPI_HandleTypeDef *, uint8_t chip_number, uint8_t *buf);
