#ifndef __INCLUDE_GUARD__TEST_CONFIGURATION_VARIABLES__
#define __INCLUDE_GUARD__TEST_CONFIGURATION_VARIABLES__
...
#endif // __INCLUDE_GUARD__TEST_CONFIGURATION_VARIABLES__