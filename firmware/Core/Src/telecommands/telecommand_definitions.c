...
const TCMD_TelecommandDefinition_t TCMD_telecommand_definitions[] = {
    ...
    },
    {
        ...
        .tcmd_func = TCMDEXEC_set_int_config_variable,
        .number_of_args = 2,
        .readiness_level = TCMD_READINESS_LEVEL_FOR_OPERATION,
    },
    {
        .tcmd_name = "config_set_str_var",
        .tcmd_func = TCMDEXEC_set_str_config_variable,
        .number_of_args = 2,
        .readiness_level = TCMD_READINESS_LEVEL_FOR_OPERATION,
    },
    {
        .tcmd_name = "config_get_int_var",
        .tcmd_func = TCMDEXEC_get_integer_configuration_variable,
        .number_of_args = 1,
        .readiness_level = TCMD_READINESS_LEVEL_FOR_OPERATION,
    },
    {
        .tcmd_name = "config_get_str_var",
        .tcmd_func = TCMDEXEC_get_string_configuration_variable,
        .number_of_args = 1,
        .readiness_level = TCMD_READINESS_LEVEL_FOR_OPERATION,
    },
    {
        .tcmd_name = "config_get_all_vars",
