...
const TCMD_TelecommandDefinition_t TCMD_telecommand_definitions[] = {
    ...
    {
        .tcmd_name = "adcs_set_asgp4_params",
        .tcmd_func = TCMDEXEC_ADCS_set_asgp4_params,
        .number_of_args = 0,
        .readiness_level = TCMD_READINESS_LEVEL_FOR_OPERATION,
    },
    {
        .tcmd_name = "adcs_get_asgp4_params",
        .tcmd_func = TCMDEXEC_ADCS_get_asgp4_params,
        .number_of_args = 0,
        .readiness_level = TCMD_READINESS_LEVEL_FOR_OPERATION,
    },
    {
    ...
    {
        .tcmd_name = "adcs_raw_css_1_to_6",
        .tcmd_func = TCMDEXEC_ADCS_raw_css_1_to_6,
        .number_of_args = 0,
        .readiness_level = TCMD_READINESS_LEVEL_FOR_OPERATION,
    },
    {
        .tcmd_name = "adcs_raw_css_7_to_10",
        .tcmd_func = TCMDEXEC_ADCS_raw_css_7_to_10,
        .number_of_args = 0,
        .readiness_level = TCMD_READINESS_LEVEL_FOR_OPERATION,
    },
    {
