...
const TCMD_TelecommandDefinition_t TCMD_telecommand_definitions[] = {
    ...
    {
        .tcmd_name = "set_obc_time_based_on_gnss_pps",
        .tcmd_func = TCMDEXEC_set_obc_time_based_on_gnss_pps,
        .number_of_args = 0,
        .readiness_level = TCMD_READINESS_LEVEL_FOR_OPERATION,
    },
    {
    ...
    {
        .tcmd_name = "config_get_all_int_vars_json",
        .tcmd_func = TCMDEXEC_config_get_all_int_vars_json,
        .number_of_args = 0,
        .readiness_level = TCMD_READINESS_LEVEL_FOR_OPERATION,
    },
    ...
    {
        .tcmd_name = "fs_demo_write_random_data",
        .tcmd_func = TCMDEXEC_fs_demo_write_random_data,
        .number_of_args = 3,
        .readiness_level = TCMD_READINESS_LEVEL_FLIGHT_TESTING,
    },
    {
    ...
    },
    {
        ...
        .tcmd_func = TCMDEXEC_fs_get_filesystem_stats_json,
        .number_of_args = 0,
        .readiness_level = TCMD_READINESS_LEVEL_FOR_OPERATION,
    },
    {
    ...
    {
        .tcmd_name = "adcs_download_sd_file_by_index",
        .tcmd_func = TCMDEXEC_adcs_download_sd_file_by_index,
        .number_of_args = 1, 
        .readiness_level = TCMD_READINESS_LEVEL_FOR_OPERATION,
    },
    {
        .tcmd_name = "adcs_download_sd_file_by_checksum",
        .tcmd_func = TCMDEXEC_adcs_download_sd_file_by_checksum,
        .number_of_args = 1, 
        .readiness_level = TCMD_READINESS_LEVEL_FOR_OPERATION,
    },  
    {
    ...
    {
        .tcmd_name = "adcs_convert_to_jpg_by_index",
        .tcmd_func = TCMDEXEC_adcs_convert_to_jpg_by_index,
        .number_of_args = 3,
        .readiness_level = TCMD_READINESS_LEVEL_FOR_OPERATION,
    },
    {
        .tcmd_name = "adcs_convert_to_jpg_by_checksum",
        .tcmd_func = TCMDEXEC_adcs_convert_to_jpg_by_checksum,
        .number_of_args = 3,
        .readiness_level = TCMD_READINESS_LEVEL_FOR_OPERATION,
    },
    {
        .tcmd_name = "adcs_get_wheel_currents",
        .tcmd_func = TCMDEXEC_adcs_get_wheel_currents,
        .number_of_args = 0,
        .readiness_level = TCMD_READINESS_LEVEL_FOR_OPERATION,
    },
    {
        .tcmd_name = "adcs_get_cubesense_currents",
        .tcmd_func = TCMDEXEC_adcs_get_cubesense_currents,
        .number_of_args = 0,
        .readiness_level = TCMD_READINESS_LEVEL_FOR_OPERATION,
    },
    {
        .tcmd_name = "adcs_get_misc_currents",
        .tcmd_func = TCMDEXEC_adcs_get_misc_currents,
        .number_of_args = 0,
        .readiness_level = TCMD_READINESS_LEVEL_FOR_OPERATION,
    },
