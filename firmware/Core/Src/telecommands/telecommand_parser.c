...
uint8_t TCMD_get_suffix_tag_hex_array(const char *str, const char *tag_name, uint8_t *value_dest) {
    ...
    DEBUG_uart_print_str("value_str: ");
    DEBUG_uart_print_str(value_str);
...
uint8_t TCMD_parse_full_telecommand(const char tcmd_str[], TCMD_TelecommandChannel_enum_t tcmd_channel,
    ...
    uint8_t sha256_hash[32]; // default value
    ...
    DEBUG_uart_print_array_hex(sha256_hash, 32);
    DEBUG_uart_print_str("\n");
    ...
    DEBUG_uart_print_str("Expected sha256 hash: ");
    DEBUG_uart_print_array_hex(expected_sha256_hash, 32);
    DEBUG_uart_print_str("\n");
