...
/// @brief The time interval between optimum antenna selection checks based on ADCS
uint32_t AX100_ADCS_based_ant_selection_interval_ms = 1200000; // TODO: Set the persistent dipole timer
...
CONFIG_integer_config_entry_t CONFIG_int_config_variables[] = {
    ...
    {
        .variable_name = "AX100_ADCS_based_ant_selection_interval_ms",
        .num_config_var = &AX100_ADCS_based_ant_selection_interval_ms,
    },    
