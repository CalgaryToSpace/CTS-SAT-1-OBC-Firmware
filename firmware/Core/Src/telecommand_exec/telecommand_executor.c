...
/// @param ts_sent The value of the `@tssent` field when the telecommand was received.
...
static uint8_t TCMD_execute_parsed_telecommand_now(const uint16_t tcmd_idx, const char args_str_no_parens[],
    uint64_t ts_sent, TCMD_TelecommandChannel_enum_t tcmd_channel, 
