...
uint8_t TEST_EXEC__SYS_low_power_mode_error_enum_to_string(void)
{
    ...
    // Camera
    SYS_low_power_mode_error_enum_t boom_error = SYS_LOW_POWER_MODE_ERROR_BOOM;
    ...
    // LFS
    SYS_low_power_mode_error_enum_t lfs_error = SYS_LOW_POWER_MODE_ERROR_LFS;
    const char* lfs_expected_string = "LFS";
    const char* lfs_str = SYS_low_power_mode_error_enum_to_string(lfs_error);
...
uint8_t TEST_EXEC__SYS_low_power_mode_error_result_to_json(void)
{
    ...
    const char *all_success_json = "{\"MPI_5V\":\"Successfully Disabled\", \"MPI_12V\":\"Successfully Disabled\", \"CAMERA\":\"Successfully Disabled\", \"BOOM\":\"Successfully Disabled\", \"GPS\":\"Successfully Set Low Power Mode\", \"ADCS\":\"Successfully Set Low Power Mode\", \"LFS\":\"Successfully Unmounted\"}";
    ...
    const char *all_error_json = "{\"MPI_5V\":\"Error Disabling\", \"MPI_12V\":\"Error Disabling\", \"CAMERA\":\"Error Disabling\", \"BOOM\":\"Error Disabling\", \"GPS\":\"Error Setting Low Power Mode\", \"ADCS\":\"Error Setting Low Power Mode\", \"LFS\":\"Error Unmounting\"}";
    SYS_low_power_mode_error_enum_t all_error = SYS_LOW_POWER_MODE_ERROR_MPI_5V | SYS_LOW_POWER_MODE_ERROR_MPI_12V |
                                           SYS_LOW_POWER_MODE_ERROR_CAMERA | SYS_LOW_POWER_MODE_ERROR_BOOM |
                                           SYS_LOW_POWER_MODE_ERROR_GPS | SYS_LOW_POWER_MODE_ERROR_ADCS |
                                           SYS_LOW_POWER_MODE_ERROR_LFS;
    ...
    const char *adcs_mpi12v_error_json = "{\"MPI_5V\":\"Successfully Disabled\", \"MPI_12V\":\"Error Disabling\", \"CAMERA\":\"Successfully Disabled\", \"BOOM\":\"Successfully Disabled\", \"GPS\":\"Successfully Set Low Power Mode\", \"ADCS\":\"Error Setting Low Power Mode\", \"LFS\":\"Successfully Unmounted\"}";
