...
void EPS_pack_eps_result_pdu_housekeeping_data_raw(const uint8_t rx_buf[], EPS_result_pdu_housekeeping_data_raw_t *result_dest) {
...
void EPS_pack_eps_result_pbu_housekeeping_data_raw(const uint8_t rx_buf[], EPS_result_pbu_housekeeping_data_raw_t *result_dest) {
	// rx_buf_len = 84
...
void EPS_pack_eps_result_pcu_housekeeping_data_raw(const uint8_t rx_buf[], EPS_result_pcu_housekeeping_data_raw_t *result_dest) {
	// rx_buf_len = 72
	result_dest->voltage_internal_board_supply_raw = (rx_buf[6]) | (rx_buf[7] << 8);
    result_dest->temperature_mcu_raw = (rx_buf[8]) | (rx_buf[9] << 8);
...
void EPS_pack_eps_result_piu_housekeeping_data_raw(const uint8_t rx_buf[], EPS_result_piu_housekeeping_data_raw_t *result_dest) {
	// rx_len = 274
    result_dest->voltage_internal_board_supply_raw = rx_buf[6] | (rx_buf[7] << 8);
    result_dest->temperature_mcu_raw = rx_buf[8] | (rx_buf[9] << 8);
