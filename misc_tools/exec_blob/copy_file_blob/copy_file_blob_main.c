...
//
// Usage Example:
// After uplinking the compiled output as "blobs/copy_file_v1.blob", run:
// CTS1+exec_blob_from_fs(blobs/copy_file_v1.blob,0,obc_boot_log.jsonl;obc_boot_log.jsonl.250B;0;250)!
